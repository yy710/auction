...
//import $http from '@/utils/request/requestConfig.js';
...
export const getServerNo = function(version,isPrompt = false, callback) {
	 ...
	 */
	//$http.get("https://www.all2key.cn/yz/auction/app_version", httpData, { isPrompt: isPrompt })
  request('/app_version', httpData)
  .then(_res => {
    const res = _res.data;
    console.log('get app_version: ', res);
